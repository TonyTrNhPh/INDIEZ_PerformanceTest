...
public class InputManager : MonoBehaviour
{
    ...
    private void StartInputTracking([Bridge.Ref] Vector2 pos)
    {
        if (currentBall == null) return;
        startInputPos = pos;
        startInputTime = Time.time;
    }
    private void UpdateInputTracking([Bridge.Ref] Vector2 pos)
    {
        if (currentBall == null) return;
    ...
    private void EndInputTracking([Bridge.Ref] Vector2 pos)
    {
        if (currentBall == null) return;
